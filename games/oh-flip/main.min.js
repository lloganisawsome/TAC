...
document.addEventListener("touchstart",function(a){K=!0;T(a);a.preventDefault()},!1);document.addEventListener("touchend",function(a){K=!1;T(a);a.preventDefault()},!1);document.addEventListener("touchcancel",function(a){K=!1;T(a);a.preventDefault()},!1);document.addEventListener("keydown",function(a){a.altKey&&"KeyR"===a.code&&(localStorage.setItem("ohflip.maxHeightFt",0),localStorage.setItem("ohflip.maxTotalFlips",0),localStorage.setItem("ohflip.goalIdx",0),O=0);"Space"===a.code&&(!K&&(K=!0,ia=.5*b.width,ja=b.height-10),a.preventDefault());"Escape"===a.code&&(ta=!ta,a.preventDefault())});document.addEventListener("keyup",function(a){"Space"===a.code&&(K=!1,a.preventDefault())});
function T(a){ia=a.pageX-b.offsetLeft;ja=a.pageY-b.offsetTop}function pa(){k=h=0;l=p=1E3;q=m=0;r=!1;G=F=t=0;H=.7;I=0;v=!1;ha=S=z=y=x=0;A=!1;C=B=0;D=!1;E=0;ta=!1}
function qa(a){if(ta){sa();window.requestAnimationFrame(qa);return}var d=Math.min((a-(ba||a))/1E3,.2);ba=a;a=b.width/b.height;var f=window.innerWidth,g=window.innerWidth/a;g>window.innerHeight&&(g=window.innerHeight,f=g*a);if(f!==ca||g!==da)b.style.width=f+"px",b.style.height=g+"px",ca=f,da=g;window.scrollTo(0,0);ra(d);a=K&&!M;v?(a=w/1,h=400*Math.cos(a*Math.PI*.5)*(fa?-1:1)*p*.001,k=200*Math.sin(a*Math.PI)*p*.001,m+=800*d*(fa?-1:1),w-=d,0>=w&&pa()):(a&&100<k?(r=!1,q+=.1*(720-q)):(r&&(m*=.8,.01>Math.abs(m)&&(r=!1)),q*=.7),a=m,m+=q*d,t+=m-a,a=y,y=Math.floor((t+
...
Z(f.text,f.x+V-3,f.y-n-3,-5*Math.PI/180,W+Math.sin(g*Math.PI*.75)*oa,"center",f.color)});ta&&(f=Math.floor(k/40),g=localStorage.getItem("ohflip.maxHeightFt")||0,n=localStorage.getItem("ohflip.maxTotalFlips")||0,Z("Paused",b.width/2,b.height/2,0,80,"center","#000"),Z("Paused",b.width/2-4,b.height/2-4,0,80,"center","#FF9600"),Z("Press Escape to resume",b.width/2,b.height/2+60,0,24,"center","#000"),Z("Press Escape to resume",b.width/2-2,b.height/2+58,0,24,"center","#FFF"),Z("Height: "+f+" ft | Flips: "+x,b.width/2,b.height/2+100,0,20,"center","#000"),Z("Height: "+f+" ft | Flips: "+x,b.width/2-2,b.height/2+98,0,20,"center","#FFF"),Z("Best Height: "+g+" ft | Best Flips: "+n,b.width/2,b.height/2+130,0,20,"center","#000"),Z("Best Height: "+g+" ft | Best Flips: "+n,b.width/2-2,b.height/2+128,0,20,"center","#AAA"));c.restore()}function U(a,d,f,g,n){ka.push({x:a,y:d,text:f,color:g,time:0,c:n||!1})}function P(a){return z>=a.a?!0:!1}function la(){return A&&0<z}function Q(a){return B>=a.a}function na(a){return C>=a.a}function ma(){return D}function R(a){return Math.floor(E/40)>=a.a}pa();window.requestAnimationFrame(qa);